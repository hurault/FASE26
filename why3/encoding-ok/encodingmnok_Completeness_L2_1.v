...
unfold atLeastOneElement.
intros.
destruct h2.
unfold nested_witness_valid in H1.
destruct H1 as [rowLM [colLM [rowRPI [colRPI [lmInF rpipos]]]]].
rewrite rowLM in lmInF.
...
generalize (surjective ((get (get (lm nw) i) j)) (lmInF i j H H0)).
intro lmInFij.
destruct lmInFij.
exists x0.
destruct H1.
